...
- [Datebase vs Data Warehouse vs Data Lake](https://github.com/TravisH0301/learning/blob/master/data_engineering/database_datawarehouse_datalake.md): Definition of database (OLTP & OLAP), data warehouse (dimension modelling & architecture) and data lake. Description of differences between them and their purposes. 
