...
Note that ORDER BY clause within the window function will be applied to the entire table, which will clash with the outer ORDER BY clause of the table.<br>
